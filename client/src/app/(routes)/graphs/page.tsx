...
export default function Home() {
    ...
    const LoadAllImages = async () => {
        ...
        try {
            const endpointsToFetch = endpoints.filter(endpoint => !fetchedEndpoints.has(endpoint));
            const fetches = endpointsToFetch.map((endpoint) => apiFetch(endpoint).then(res => res.blob()));

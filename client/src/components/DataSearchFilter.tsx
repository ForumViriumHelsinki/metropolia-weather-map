...
const FilterDataComponent: React.FC = () => {
    ...
    return (
        <div className="w-min border bg-offWhite border-gray-300 rounded shadow p-4">
        {/* Header */}
        <div className="bg-offWhite py-2 mb-4">
        ...
        {/* Date Range */}
        <div className="mb-3">
      <label className="block mb-1 text-sm font-medium">Date/Time Range</label>
      <div className="flex space-x-2">
        ...
        <div className="flex items-center mb-3">
          ...
          <input
            type="number"
            className="border border-gray-300 rounded px-2 py-1 text-sm w-16 mr-2"
            placeholder="From"
        ...
        <div className="flex justify-end mt-4">
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-4 rounded mr-2 text-sm"
          >
            Submit
          </button>
          <button
